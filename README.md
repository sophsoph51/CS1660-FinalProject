...
* <u>Assumptions:</u>
  ...
  * You have a cluster running on their Google Platform Cloud (GCP) Account
  * The JSON credentials file is downloaded for your specific cluster
  * You know how to add jar files to Eclipse by right clicking on the project and going to Configure Build Path to add external jars
